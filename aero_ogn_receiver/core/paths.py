...
def data_path(name: str) -> Path:
    return Path(str(resources.files("aero_ogn_receiver.data").joinpath(name)))


def template_path(name: str) -> Path:
    return Path(str(resources.files("aero_ogn_receiver.templates").joinpath(name)))
...
def example_config_path() -> Path:
    ...
    share_candidate = Path("/usr/share/aero-ogn-receiver/config.example.yaml")
